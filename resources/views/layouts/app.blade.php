            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        ...
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ asset('public/frontend') }}/images/mail.png" alt=""></div><a href="mailto:fastsales@gmail.com">excommerce@gmail.com</a></div>
                ...
                <div class="row sm">
                    ...
                    <div class="col-lg-3 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ url('/') }}">ExCommerce</a></div>
                        </div>
                    </div>

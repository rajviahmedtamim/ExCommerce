                            ...
                            <form action="{{ route('seo.setting.update', $data->id) }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <textarea class="form-control" name="meta_description">{{ $data->met_description }}</textarea>
                                    </div>

                                  <strong class="text-center text-success">----Others Option---</strong><br><br>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Google Analytiics</label>

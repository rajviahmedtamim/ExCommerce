    ...
    <div class="banner">
        ...
        <div class="container fill_height">
            <div class="row fill_height">
                <div class="banner_product_image "><img class="mb-3 px-5"  style="width: 400px;height: auto" src="{{ asset('public/files/product/'.$bannerproduct->thumbnail) }}" alt="{{ $bannerproduct->name }}"></div>
                <div class="col-lg-5 offset-lg-4 fill_height">
                    <div class="banner_content">
                        <h1 class="banner_text">{{ $bannerproduct->name }}</h1>
                        @if($bannerproduct->discount_price==NULL)
                        <div class="banner_price">{{ $settings->currency }}{{ $bannerproduct->selling_price }}</div>
                        @else
                            <div class="banner_price"><span>{{ $settings->currency }}{{ $bannerproduct->selling_price }}</span>{{ $settings->currency }}{{ $bannerproduct->discount_price }}</div>
                        @endif
